...
```
$ go get -u github.com/kermitbu/grapes/grpc/examples/helloworld/greeter_client
$ go get -u github.com/kermitbu/grapes/grpc/examples/helloworld/greeter_server
```
