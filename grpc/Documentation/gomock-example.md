...
From the directory ``` examples/helloworld/mock/ ``` run ``` mockgen github.com/kermitbu/grapes/grpc/examples/helloworld/helloworld GreeterClient > mock_helloworld/hw_mock.go ```
...
import hwmock "github.com/kermitbu/grapes/grpc/examples/helloworld/mock/mock_helloworld"
```
